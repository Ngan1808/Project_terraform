...
variable "custom_key_store_id" {
  description = "ID of the KMS Custom Key Store where the key will be stored instead of KMS (e.g., CloudHSM)."
  type        = string
  default     = null
}
...
variable "key_service_roles_for_autoscaling" {
  description = "A list of IAM ARNs for AWS Service roles for Auto Scaling."
  type        = list(string)
  default     = []
}
